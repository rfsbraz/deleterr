...
| `min_deletions_to_notify` | integer | No | `0` | Minimum deletions required to send a notification. Set to 0 to always notify |
...
| Property | Type | Required | Default | Description |
|----------|------|----------|---------|-------------|
| `webhook_url` | string | Yes | - | Discord webhook URL. Create one in Server Settings → Integrations → Webhooks |
...
| Property | Type | Required | Default | Description |
|----------|------|----------|---------|-------------|
| `webhook_url` | string | Yes | - | Slack Incoming Webhook URL. Create one at api.slack.com/apps |
...
| `chat_id` | string | Yes | - | Telegram chat ID (user, group, or channel). Use @userinfobot to find your ID |
...
| Property | Type | Required | Default | Description |
|----------|------|----------|---------|-------------|
| `url` | string | Yes | - | Webhook URL to receive JSON payloads |
| `method` | string | No | `"POST"` | HTTP method: POST or PUT |
| `headers` | object | No | - | Custom HTTP headers to include with requests |
